        ...
        return(
            <div style={{marginLeft : '30px', marginRight : '30px'}}>
                ...
                <Row>
                    ...
                    <Input s={6} label=' ' placeholder="Purchased Quantity" type='number' min={0} value = {this.state.purchased_quantity.value} onChange = {this.setPurchaseQuantity} error={this.state.purchased_quantity.showError ? this.state.purchased_quantity.error : null} />
                    <Input s={6} label=' ' placeholder="Price" type='number' min={0} value = {this.state.item_price.value} onChange = {this.setItemPrice} error={this.state.item_price.showError ? this.state.item_price.error : null} />
                    <Input s={6} label=' ' placeholder="GST %" type='number' min={0} value = {this.state.gst.value} onChange = {this.setGst} error={this.state.gst.showError ? this.state.gst.error : null} />
                    <Input s={6} label=' ' placeholder="Discount %" type='number' min={0} value = {this.state.discount.value} onChange = {this.setDiscount} error={this.state.discount.showError ? this.state.discount.error : null} />
